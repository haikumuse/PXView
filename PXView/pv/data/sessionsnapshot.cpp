...
view::MathTrace* SessionSnapshot::get_math_trace()
{
    return _math_trace;
}
...
uint64_t SessionSnapshot::cur_samplelimits()
{
...
data::LogicSnapshot* SessionSnapshot::get_logic_snapshot()
{
    return &_logic;
}
...
data::DsoSnapshot* SessionSnapshot::get_dso_snapshot()
{
    return &_dso;
}
...
uint64_t SessionSnapshot::get_trigger_pos()
{
    return _trig_pos;
}
...
void SessionSnapshot::set_trigger_pos(uint64_t pos)
{
    _trig_pos = pos;
}
