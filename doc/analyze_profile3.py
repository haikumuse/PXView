...
profile_path = "C:/Users/admin/Downloads/PXView.exe 2026-05-20 13.20 profile.json"
...
for t in threads:
    ...
    start_window = min_time + 18000.0  # 18s onwards
    ...
    print(f"\n=======================================================")
    print(f"MAIN THREAD: {name} (TID: {t.get('tid')}) - Samples >= 18s: {in_window_weight}")
    print(f"=======================================================")
    ...
    if total_active > 0:
        for rank, (path, cnt) in enumerate(sorted_paths[:5]):
