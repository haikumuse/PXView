...
public:
    ...
    void setupUi(QMenuBar *QRibbon)
    {
        ...
        QRibbon->resize(994, 100);
        QRibbon->setMinimumSize(QSize(0, 100));
        ...
        widgetContainer->setEnabled(true);
        widgetContainer->setMinimumSize(QSize(0, 103));
        widgetContainer->setMaximumSize(QSize(16777215, 16777215));
