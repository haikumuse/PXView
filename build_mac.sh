...
#
cp -R /usr/local/opt/python@${PYTHON_VER}/Frameworks/Python.framework ${BUNDLE}/Contents/Frameworks
install_name_tool \
    -change /usr/local/opt/python@${PYTHON_VER}/Frameworks/Python.framework/Versions/${PYTHON_VER}/Python \
    '@executable_path/../Frameworks/Python.Framework/Versions/Current/Python' ${BUNDLE}/Contents/MacOS/PXView
