	...
	const struct sr_dev_inst *sdi, const struct sr_channel_group *cg)
{
	...
	case SR_CONF_LIMIT_SAMPLES:
		...
		break;
	case SR_CONF_SAMPLE_INTERVAL:
		if ((idx = local_std_u64_tuple_idx(data, ARRAY_AND_SIZE(kecheng_kc_330b_sample_intervals))) < 0)
			return SR_ERR_ARG;
...
static int dev_acquisition_start(const struct sr_dev_inst *sdi)
{
	...
	sr_session_source_add(-1 * (size_t)drvc->sr_ctx->libusb_ctx, 0, 10,
		kecheng_kc_330b_handle_events, sdi);
...
static struct sr_dev_driver *kecheng_kc_330b_drv_ptr;
...
static int kecheng_kc_330b_compat_init(struct sr_context *sr_ctx)
{
	kecheng_kc_330b_drv_ptr = &kecheng_kc_330b_driver_info;
	return std_init(kecheng_kc_330b_drv_ptr, sr_ctx);
}

/* Wrapper: PXView cleanup(void) -> standard cleanup(driver) */
static int kecheng_kc_330b_compat_cleanup(void)
{
	return std_cleanup(kecheng_kc_330b_drv_ptr);
}

/* Wrapper: PXView scan(options) -> standard scan(driver, options) */
static GSList *kecheng_kc_330b_compat_scan(GSList *options)
{
	return scan(kecheng_kc_330b_drv_ptr, options);
}

/* Wrapper: PXView config_get(id,data,sdi,ch,cg) -> standard(key,data,sdi,cg) */
static int kecheng_kc_330b_compat_config_get(int id, GVariant **data,
...
static int kecheng_kc_330b_compat_config_set(int id, GVariant *data,
...
static int kecheng_kc_330b_compat_config_list(int info_id, GVariant **data,
	const struct sr_dev_inst *sdi, const struct sr_channel_group *cg)
{
...
static int kecheng_kc_330b_compat_acquisition_start(struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
...
static int kecheng_kc_330b_compat_acquisition_stop(const struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
...
SR_PRIV struct sr_dev_driver kecheng_kc_330b_driver_info = {
	...
	.init = kecheng_kc_330b_compat_init,
	.cleanup = kecheng_kc_330b_compat_cleanup,
	.scan = kecheng_kc_330b_compat_scan,
	.dev_mode_list = compat_dev_mode_list_default,
	.config_get = kecheng_kc_330b_compat_config_get,
	.config_set = kecheng_kc_330b_compat_config_set,
	.config_list = kecheng_kc_330b_compat_config_list,
	.dev_open = dev_open,
	.dev_close = dev_close,
	.dev_destroy = compat_dev_destroy_default,
	.dev_status_get = compat_dev_status_get_default,
	.dev_acquisition_start = kecheng_kc_330b_compat_acquisition_start,
	.dev_acquisition_stop = kecheng_kc_330b_compat_acquisition_stop,
	.priv = NULL,
};
