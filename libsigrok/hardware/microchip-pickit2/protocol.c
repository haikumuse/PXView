...
static int pickit2_retrieve_bank(const struct sr_dev_inst *sdi,
...
static int pickit2_retrieve_sample_data(const struct sr_dev_inst *sdi)
{
	struct dev_context *devc;
	uint8_t *rdpos;
	size_t rdlen;
...
static int pickit2_submit_logic_data(const struct sr_dev_inst *sdi)
{
	struct dev_context *devc;
	struct {
