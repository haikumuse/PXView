...
static struct sr_dev_driver *flukedmm_drv_ptr;

/* Forward declaration - defined at end of file */
extern struct sr_dev_driver flukedmm_driver_info;

/* Wrapper: PXView init(sr_ctx) -> standard init(driver, sr_ctx) */
static int flukedmm_compat_init(struct sr_context *sr_ctx)
{
	flukedmm_drv_ptr = &flukedmm_driver_info;
	return std_init(flukedmm_drv_ptr, sr_ctx);
}

/* Wrapper: PXView cleanup(void) -> standard cleanup(driver) */
static int flukedmm_compat_cleanup(void)
{
	return std_cleanup(flukedmm_drv_ptr);
}

/* Wrapper: PXView scan(options) -> standard scan(driver, options) */
static GSList *flukedmm_compat_scan(GSList *options)
{
	return scan(flukedmm_drv_ptr, options);
}

/* Wrapper: PXView config_get(id,data,sdi,ch,cg) -> standard(key,data,sdi,cg) */
static int flukedmm_compat_config_get(int id, GVariant **data,
...
static int flukedmm_compat_config_set(int id, GVariant *data,
...
static int flukedmm_compat_config_list(int info_id, GVariant **data,
	const struct sr_dev_inst *sdi, const struct sr_channel_group *cg)
{
...
static int flukedmm_compat_acquisition_start(struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
...
static int flukedmm_compat_acquisition_stop(const struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
...
struct sr_dev_driver flukedmm_driver_info = {
	.name = "fluke-dmm",
	.longname = "Fluke 8x/18x/28x series DMMs",
	.api_version = 1,
	.driver_type = DRIVER_TYPE_HARDWARE,
	.init = flukedmm_compat_init,
	.cleanup = flukedmm_compat_cleanup,
	.scan = flukedmm_compat_scan,
	.dev_mode_list = compat_dev_mode_list_default,
	.config_get = flukedmm_compat_config_get,
	.config_set = flukedmm_compat_config_set,
	.config_list = flukedmm_compat_config_list,
	.dev_open = std_serial_dev_open,
	.dev_close = std_serial_dev_close,
	.dev_destroy = compat_dev_destroy_default,
	.dev_status_get = compat_dev_status_get_default,
	.dev_acquisition_start = flukedmm_compat_acquisition_start,
	.dev_acquisition_stop = flukedmm_compat_acquisition_stop,
	.priv = NULL,
};