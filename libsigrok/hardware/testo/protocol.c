...
SR_PRIV int testo_probe_channels(struct sr_dev_inst *sdi)
{
	...
	/*
	 * PXView's libsigrok does not provide sr_dev_open()/sr_dev_close()
	 * public APIs. Dispatch to the driver's dev_open/dev_close callbacks
	 * directly. The scan() function sets sdi->driver before calling us.
	 */
