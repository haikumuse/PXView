...
/* PURGE_FTDI_BOTH compat - not available in all ftdi.h versions */
#ifndef PURGE_FTDI_BOTH
#define PURGE_FTDI_BOTH(ftdi) ftdi_usb_purge_buffers(ftdi)
#endif
...
/* Callback to periodically drive acquisition progress. */
