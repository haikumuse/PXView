...
static struct sr_dev_driver *saleae_logic_pro_drv_ptr;
...
static GSList *scan(struct sr_dev_driver *di, GSList *options)
{
	...
	return std_scan_complete_compat(saleae_logic_pro_drv_ptr, devices);
}
...
/* PXView compat wrapper functions */
static int saleae_logic_pro_compat_init(struct sr_context *sr_ctx)
{
	saleae_logic_pro_drv_ptr = &saleae_logic_pro_driver_info;
	return std_init(saleae_logic_pro_drv_ptr, sr_ctx);
}

static int saleae_logic_pro_compat_cleanup(void)
{
	return std_cleanup(saleae_logic_pro_drv_ptr);
}

static GSList *saleae_logic_pro_compat_scan(GSList *options)
{
	return scan(saleae_logic_pro_drv_ptr, options);
}

static int saleae_logic_pro_compat_config_get(int id, GVariant **data,
...
static int saleae_logic_pro_compat_config_set(int id, GVariant *data,
...
static int saleae_logic_pro_compat_config_list(int info_id, GVariant **data,
	const struct sr_dev_inst *sdi, const struct sr_channel_group *cg)
{
	return config_list((uint32_t)info_id, data, sdi, cg);
}

static int saleae_logic_pro_compat_acquisition_start(struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
	return dev_acquisition_start(sdi);
}

static int saleae_logic_pro_compat_acquisition_stop(const struct sr_dev_inst *sdi, void *cb_data)
{
	(void)cb_data;
...
struct sr_dev_driver saleae_logic_pro_driver_info = {
	.name = "saleae-logic-pro",
	.longname = "Saleae Logic Pro",
	.api_version = 1,
	.driver_type = DRIVER_TYPE_HARDWARE,
	.init = saleae_logic_pro_compat_init,
	.cleanup = saleae_logic_pro_compat_cleanup,
	.scan = saleae_logic_pro_compat_scan,
	.dev_mode_list = compat_dev_mode_list_default,
	.config_get = saleae_logic_pro_compat_config_get,
	.config_set = saleae_logic_pro_compat_config_set,
	.config_list = saleae_logic_pro_compat_config_list,
	.dev_open = dev_open,
	.dev_close = dev_close,
	.dev_destroy = compat_dev_destroy_default,
	.dev_status_get = compat_dev_status_get_default,
	.dev_acquisition_start = saleae_logic_pro_compat_acquisition_start,
	.dev_acquisition_stop = saleae_logic_pro_compat_acquisition_stop,
	.priv = NULL,
};