...
/* Terminator for the agdmm_job/agdmm_recv tables (standard sigrok idiom). */
#ifndef ALL_ZERO
#define ALL_ZERO { 0 }
#endif
...
/*
 * PXView does not provide sr_next_enabled_channel(). Declare the local
 * implementation (defined in protocol.c) so both api.c and protocol.c can
 * iterate over the device's enabled channels the standard sigrok way.
 */
