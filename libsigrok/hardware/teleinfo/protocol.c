...
static struct sr_channel *teleinfo_find_channel(const struct sr_dev_inst *sdi,
                                            const char *name)
{
...
static void teleinfo_send_value(const struct sr_dev_inst *sdi,
...
static gboolean teleinfo_parse_group(const struct sr_dev_inst *sdi,
...
static const uint8_t *teleinfo_parse_data(const struct sr_dev_inst *sdi,
