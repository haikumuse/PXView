...
$FoldersToCopy = @("PXView", "libsigrok", "libsigrokdecode", "common", "lang", "CMake", "debian", "web", "doc", "libusb", "sigrok-firmware", "sigrok-firmware-fx2lafw")
$FilesToCopy = @(
    "CMakeLists.txt", "logo-win.ico", "applogo.rc", "README.md", "INSTALL.md", "INSTALL_zh.md", "COPYING", "LICENSE",
    "PXView.icns", "clean", "cmake_clear", "build_linux", ".gitmodules", "$([char]0x66F4)$([char]0x65B0)$([char]0x8BF4)$([char]0x660E).txt"
)
